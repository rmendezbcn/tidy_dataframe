...
traindf_selected_columns <- names(adl_train_data_df4)[
        grepl('mean|std|activitycode|subjectcode|dataset', names(adl_train_data_df4))]
...
testdf_selected_columns <- names(adl_test_data_df4)[
        grepl('mean|std|activitycode|subjectcode|dataset', names(adl_test_data_df4))]
...
cat('\n', 'writing the resulting df to the working directory as activitiesdailyliving.csv', sep = ' ')
write.csv(merged_df, file = toString(paste(getwd(),'/activitiesdailyliving.csv', sep = '')))
...
cat('\n\n', 'writing the resulting df to the working directory as dataset_activity_subject_mean_df.csv', sep = ' ')
write.csv(dataset_activity_subject_mean_df, file = toString(paste(getwd(),'/dataset_activity_subject_mean_df.csv', sep = '')))

cat('\n\n', 'writing the resulting df to the working directory as activity_subject_mean_df.csv', sep = ' ')
write.csv(activity_subject_mean_df, file = toString(paste(getwd(),'/activity_subject_mean_df.csv', sep = '')))
